...
|---|---|
| **Ambiente de desarrollo** | Local con VS Code + Live Server en `http://localhost:5501` |
...
| **Node.js** | v18+ | Runtime para ejecutar Playwright |
| **Google Chrome** | 124+ | Navegador de ejecución |
| **VS Code** | 1.89+ | IDE de desarrollo y ejecución |
| **Live Server (VS Code)** | 5.7+ | Servidor local para la aplicación |
